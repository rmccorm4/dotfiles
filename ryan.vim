...
hi SpecialComment guifg=#0088ff guibg=NONE guisp=NONE gui=bold,italic ctermfg=80 ctermbg=NONE cterm=bold
hi Typedef guifg=#40e0d0 guibg=NONE guisp=NONE gui=bold ctermfg=33 ctermbg=NONE cterm=bold
...
hi Include guifg=#c526ff guibg=NONE guisp=NONE gui=NONE ctermfg=33 ctermbg=NONE cterm=bold
hi Float guifg=#ff0044 guibg=NONE guisp=NONE gui=NONE ctermfg=196 ctermbg=NONE cterm=bold
...
hi Identifier guifg=#40e0d0 guibg=NONE guisp=NONE gui=NONE ctermfg=33 ctermbg=NONE cterm=NONE
hi SpecialChar guifg=#c526ff guibg=NONE guisp=NONE gui=bold ctermfg=46 ctermbg=NONE cterm=bold
hi Conditional guifg=#ff9d00 guibg=NONE guisp=NONE gui=bold ctermfg=197 ctermbg=NONE cterm=bold
hi StorageClass guifg=#40e0d0 guibg=NONE guisp=NONE gui=bold,italic ctermfg=80 ctermbg=NONE cterm=bold
hi Todo guifg=#ffdd00 guibg=#000000 guisp=#000000 gui=NONE ctermfg=197 ctermbg=NONE cterm=NONE
hi Special guifg=#c526ff guibg=NONE guisp=NONE gui=bold ctermfg=46 ctermbg=NONE cterm=bold
...
hi Label guifg=#ff9d00 guibg=NONE guisp=NONE gui=bold ctermfg=197 ctermbg=NONE cterm=bold
...
hi Statement guifg=#ff9d00 guibg=NONE guisp=NONE gui=bold ctermfg=197 ctermbg=NONE cterm=bold
hi Comment guifg=#0088ff guibg=NONE guisp=NONE gui=italic ctermfg=80 ctermbg=NONE cterm=bold
hi Character guifg=#ff0044 guibg=NONE guisp=NONE gui=NONE ctermfg=226 ctermbg=NONE cterm=bold
hi TabLineSel guifg=#ffffff guibg=#0088ff guisp=#0088ff gui=bold ctermfg=15 ctermbg=33 cterm=bold
hi Number guifg=#ff0044 guibg=NONE guisp=NONE gui=NONE ctermfg=208 ctermbg=NONE cterm=bold
hi Boolean guifg=#ff0044 guibg=NONE guisp=NONE gui=NONE ctermfg=220 ctermbg=NONE cterm=NONE
hi Operator guifg=#ff9d00 guibg=NONE guisp=NONE gui=bold ctermfg=197 ctermbg=NONE cterm=bold
...
hi Function guifg=#40e0d0 guibg=NONE guisp=NONE gui=bold ctermfg=33 ctermbg=NONE cterm=bold
...
hi Exception guifg=#ff9d00 guibg=NONE guisp=NONE gui=bold ctermfg=197 ctermbg=NONE cterm=bold
hi Keyword guifg=#ffdd00 guibg=NONE guisp=NONE gui=bold ctermfg=197 ctermbg=NONE cterm=bold
hi Type guifg=#40e0d0 guibg=NONE guisp=NONE gui=bold ctermfg=33 ctermbg=NONE cterm=bold
...
hi SpecialKey guifg=#ffdd00 guibg=NONE guisp=NONE gui=NONE ctermfg=5 ctermbg=NONE cterm=NONE
hi Constant guifg=#ff0044 guibg=NONE guisp=NONE gui=NONE ctermfg=197 ctermbg=NONE cterm=NONE
hi Tag guifg=#ff9d00 guibg=NONE guisp=NONE gui=NONE ctermfg=197 ctermbg=NONE cterm=NONE
hi String guifg=#3ad900 guibg=NONE guisp=NONE gui=NONE ctermfg=226 ctermbg=NONE cterm=bold
...
hi Repeat guifg=#ff9d00 guibg=NONE guisp=NONE gui=bold ctermfg=197 ctermbg=NONE cterm=bold
hi Directory guifg=#2c355e guibg=NONE guisp=NONE gui=bold ctermfg=17 ctermbg=NONE cterm=bold
hi Structure guifg=#ff9d00 guibg=NONE guisp=NONE gui=bold ctermfg=197 ctermbg=NONE cterm=bold
hi Macro guifg=#ffdd00 guibg=NONE guisp=NONE gui=NONE ctermfg=197 ctermbg=NONE cterm=NONE
